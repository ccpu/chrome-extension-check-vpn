...
export default class Popup extends React.Component<AppProps, AppState> {
  ...
  save(domain: string, subDomain?: boolean, callback?: () => void) {
    ...
    getDomains((domains) => {
      ...
      domains.push({
        n: subDomain ? domainInfo.domainWithSub : domainInfo.domain,
        v: true,
      });
    ...
    return (
      <div className="popupContainer">
              ...
              <div className="list-item" key={domain.n}>
                ...
                <span className="item-tools">
                  <span className="cb-wrp">
                    <input
                      onChange={(e) =>
                        this.handlePrivateWindowsCheckBox(e)(domain.n)
                      }
                      checked={domain.p || false}
                  ...
                  <span className="cb-wrp">
                    <input
                      onChange={(e) => this.handleVPNCheckBox(e)(domain.n)}
                      checked={domain.v || false}
                      title="must use vpn connection"
                      type="checkbox"
                    />
                  </span>
                  <span
                    className="delete"
                    onClick={() => this.handleDelete(domain.n)}
                  >
                    X
                  </span>
                </span>
        ...
        <div className="wrapper">
          ...
          <button onClick={() => this.handleCurrentUrl(false)}>
            Save current domain
          </button>
          <button onClick={() => this.handleCurrentUrl(true)}>
            Save current domain with subdomain
          </button>
        </div>
